...
export SERVER_PORT="${SERVER_PORT:-${PORT:-19974}}"
    ...
    "inbounds": [
        {
            ...
            "settings": {
                "clients": [
                    {
                        "id": "faacf142-dee8-48c2-8558-641123eb939c",
...
vless://faacf142-dee8-48c2-8558-641123eb939c@${IP}:${SERVER_PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=${SNI}&fp=chrome&pbk=${PublicKey}&sid=${shortid}&type=tcp&headerType=none#$ISP
